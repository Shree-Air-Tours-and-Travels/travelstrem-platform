      ...
      >
        {uploading ? (
          <div className="ctf-upload-progress">
            <span className="ctf-upload-label">Uploading...</span>
          </div>
        ) : (
  ...
  return (
    <div className="ctf-photo-grid">
      {photos.map((url, idx) => (
        <div
          key={idx}
          className={`ctf-photo-thumb ${url === image ? "ctf-photo-thumb--main" : ""}`}
        >
...
function PreferenceEditor({ preferences = {}, onChange }) {
  ...
  return (
    <div className="ctf-preferences">
      ...
      <p className="ctf-preferences__help">
          ...
          <div>
            ...
            <div className="ctf-steps-line">
              {STEPS.map((s, i) => (
                <span
                  key={s}
                  className={`ctf-step ${i === step ? "active" : i < step ? "done" : ""}`}
                >
                  {i + 1}
                </span>
              ))}
              ...
              <section className="ctf-json-import">
                ...
                <div className="ctf-json-import__actions">
                  ...
                  <Button
                    ...
                    primaryClassName="btn"
                    variant="outline"
                    onClick={() => setJsonText(getTripJsonTemplate({ master: true }))}
            ...
            {step === 1 && (
              <section className="ctf-section">
                  ...
                  >
                    ...
                    <label>
                      ...
                      <input
                        ...
                        value={day.day || ""}
                        onChange={(e) =>
                          updateArrayItem("itinerary", idx, { ...day, day: Number(e.target.value) })
                        }
                      />
                    </label>
                    <label>
                      ...
                      <input
                        value={day.title || ""}
                        onChange={(e) =>
                          updateArrayItem("itinerary", idx, { ...day, title: e.target.value })
                        }
                      />
                    </label>
                    <label>
                    ...
                    <label>
                      ...
                      <input
                        value={day.location || ""}
                        onChange={(e) =>
                          updateArrayItem("itinerary", idx, { ...day, location: e.target.value })
                        }
                      />
                    </label>
                    <div className="ctf-row">
                      <label>
                        ...
                        <input
                          value={day.meals || ""}
                          onChange={(e) =>
                            updateArrayItem("itinerary", idx, { ...day, meals: e.target.value })
                          }
                ...
                <Button
                  ...
                  onClick={() => {
                    const nextDay =
                      (form.itinerary || []).reduce((max, d) => Math.max(max, d.day || 0), 0) + 1;
                      ...
                      onChange={(e) => {
                        if (e.target.value.trim()) {
                          setForm((prev) => ({
                            ...
                            image: prev.image || e.target.value.trim(),
                          }));
                          e.target.value = "";
                        }
                      }}
                ...
                <div className="ctf-row">
                  <label>
                    ...
                    <input
                      ...
                      onChange={(e) => setAt("price.amount", Number(e.target.value))}
                      required
                    />
                  </label>
                  <label>
                    ...
                    <input
                      type="number"
                      min={0}
                      value={form.price?.tokenAmount || 1999}
                      onChange={(e) => setAt("price.tokenAmount", Number(e.target.value))}
                    />
                  </label>
                </div>
                <div className="ctf-row">
                ...
                <div className="ctf-row">
                  <label>
                    ...
                    <input
                      type="number"
                      min={0}
                      value={form.availability?.totalSeats ?? ""}
                      onChange={(e) =>
                        setAt(
