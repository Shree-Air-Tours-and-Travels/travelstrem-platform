    ...
    <div className="modal-backdrop" onClick={onCancel}>
      <div className="cf-modal" onClick={(e) => e.stopPropagation()}>
        <div className="cf-header">
          ...
          <button className="cf-close" onClick={onCancel}>&times;</button>
        </div>
        ...
        <form onSubmit={onSubmit}>
          <div className="cf-section">
            ...
            <div className="cf-row">
              ...
              <label>
                <span>Slug *</span>
                <input type="text" value={form.slug} onChange={(e) => onChange("slug", e.target.value)} required pattern="[a-z0-9\-]+" />
              </label>
            </div>
            <div className="cf-row">
              <label>
                ...
                <div key={product} className="cf-product">
                  ...
                  <div className="cf-row cf-row--branding">
                    <label>
                      ...
                      <input type="text" value={b.name || ""} onChange={(e) => onBrandingChange(product, "name", e.target.value)} />
                    </label>
                    <label>
                      <span>Subtitle</span>
