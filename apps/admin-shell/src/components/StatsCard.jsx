...
export default function StatsCard({ label, value, icon, trend, trendLabel, onClick }) {
  const Tag = onClick ? "button" : "div";
  return (
    <Tag
      className={`dsc${onClick ? " dsc--clickable" : ""}`}
      onClick={onClick}
    ...
    >
      ...
      {(trend || trendLabel) && (
        <div
          className={`dsc__trend ${trend === "up" ? "dsc__trend--up" : trend === "down" ? "dsc__trend--down" : ""}`}
        >
          {trend === "up" && (
