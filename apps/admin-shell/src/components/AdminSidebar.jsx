...
const TABS = [
  ...
  },
  {
    ...
    icon: "M21 15a4 4 0 01-4 4H8l-5 3V7a4 4 0 014-4h10a4 4 0 014 4v8zM7 8h10M7 12h7",
  },
  {
    id: "services",
    label: "Services",
  ...
  },
  {
    ...
    icon: "M3 21h18M5 21V7l7-4 7 4v14M9 21v-5h6v5M9 9h.01M15 9h.01M9 12h.01M15 12h.01",
  },
  {
    id: "clients",
    label: "Clients",
    ...
    <>
      <aside className={`dash-sidebar ${mobileOpen ? "is-mobile-open" : ""}`}>
        ...
        <nav className="dsb-nav">
          {TABS.filter((tab) => tab.id !== "tenancy" || user?.adminLevel === "master").map(
            (tab) => (
              <button
                key={tab.id}
      ...
      {mobileOpen && (
        <button className="dsb-backdrop" onClick={onMobileClose} aria-label="Close navigation" />
      )}
    </>
  );
}
