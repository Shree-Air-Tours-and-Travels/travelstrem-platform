    ...
    return (
        <>
            <Routes>
                ...
                <Route path="/admin/bookings" element={<Navigate to="/manage/tours?tab=enquiries" replace />} />
                <Route path="/manage/bookings" element={<Navigate to="/manage/tours?tab=enquiries" replace />} />
