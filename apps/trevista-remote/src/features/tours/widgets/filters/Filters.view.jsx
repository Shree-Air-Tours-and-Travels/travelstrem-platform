            ...
            <div className="filters-card__sticky">
                <div className="filters-card__header">
                    ...
                    <div className="filters-card__header-right">
                        <Button
                            text={expanded ? (labels.hideFilters || "Hide") : `${labels.showFilters || "Filters"}${activeCount ? ` (${activeCount})` : ""}`}
                    ...
                    <>
                        <div className="filters-card__actions">
                            ...
                            <div className="filters-status">
                                {loadingAction && <span className="filters-status__loading">{labels.processing || "Processing…"}</span>}
                                {message && <span className={`filters-status__${message.type}`}>{message.text}</span>}
                                {!message && lastResultCount !== null && <span>{lastResultCount} {labels.results || "results"}</span>}
                            </div>
                        </div>
                                        ...
                                        return (
                                            <div className="filters-col" key={fieldName}>
                                                <FieldViewResolver
                                                    ...
                                                    field={{
                                                        ...field,
                                                        options: serverOptions[field.optionsRef || fieldName] || field.options || serverOptions,
                                                    }}
