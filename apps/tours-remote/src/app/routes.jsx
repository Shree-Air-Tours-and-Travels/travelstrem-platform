...
export default function AppRoutes({ dispatchEvent, embedded = false, userSession = null }) {
    ...
    return (
        <Routes>
            ...
            <Route path="/tours/bookings/:bookingId" element={<BookingSummaryPage {...routeProps} />} />
            <Route path="/tours/bookings/:bookingId/checkout" element={<BookingCheckoutPage {...routeProps} />} />
            <Route path="/tours/:tourRef/book" element={<BookingPage {...routeProps} />} />
            <Route path="*" element={<Navigate to="/tours" replace />} />
        </Routes>
    );
}
