  ...
  const recentItems =
    tab === "dashboard"
      ? [
          ...
          ...(state.value?.recentCustomers || []).map((item) => ({
            ...item,
  ...
  return (
    <section className="partner-workspace">
      ...
      {state.loading ? (
        ...
        <>
          <div className="partner-workspace__metrics">
            ...
            <>
              ...
              <div className="partner-workspace__list">
                {recentItems.map((item, index) => (
                  <article key={`${item.workspaceKind}-${item._id || index}`}>
                    <div>
                      <strong>
                        {item.title || item.name || item.bookingRef || pretty(item.workspaceKind)}
                      </strong>
                      <span>{item.workspaceKind}</span>
                    </div>
        ...
        <div className="partner-workspace__list">
          {items.map((item) => (
            <article key={item._id}>
              ...
              />
              {tab === "agents" && isAdmin && item.agencyRole === "partner_agent" && (
                <div className="partner-workspace__actions">
                  <Button
                      ...
                      perform(
                        () =>
                          api.patch(`/tenancy/users/${item._id}`, {
                            accountStatus:
                              item.accountStatus === "active" ? "deactivated" : "active",
                          }),
                  ...
                  <Button
                    ...
                    variant="text"
                    onClick={() => {
                      setForm((value) => ({ ...value, agentId: item._id }));
                      setShowCreate(true);
                    }}
                  />
                </div>
