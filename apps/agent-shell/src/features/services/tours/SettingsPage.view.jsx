...
export default function SettingsPage({
  ...
  React.useEffect(() => {
    setName(get(profile, "name") || get(auth, "user.name") || "");
  }, [profile, auth]);
  React.useEffect(() => {
  ...
  const handleProfileSubmit = async (e) => {
    ...
    try {
      ...
      setToast({
        message: pageConfig.toast.profileUpdated.message,
        type: pageConfig.toast.profileUpdated.type,
        visible: true,
      });
      dismissToastAfter(3000);
    } catch (err) {
      setToast({
        message: err.message || pageConfig.toast.profileFailed.message,
        type: "error",
        visible: true,
      });
      dismissToastAfter(3000);
  ...
  const handlePassSubmit = async (e) => {
    ...
    if (passForm.newPassword.length < 6) {
      setPassError(pwSection.error.minLength);
      return;
    }
    if (passForm.newPassword !== passForm.confirmPassword) {
      setPassError(pwSection.error.mismatch);
      return;
    }
    ...
    try {
      ...
      setToast({
        message: pageConfig.toast.passwordUpdated.message,
        type: pageConfig.toast.passwordUpdated.type,
        visible: true,
      });
      dismissToastAfter(3000);
    } catch (err) {
  ...
  const handleAvatarSelect = async (icon) => {
    ...
    try {
      ...
      setToast({
        message: pageConfig.toast.avatarUpdated.message,
        type: pageConfig.toast.avatarUpdated.type,
        visible: true,
      });
      dismissToastAfter(3000);
    } catch (err) {
      setSelectedAvatar(profileAvatar);
      setToast({
        message: err.message || pageConfig.toast.avatarFailed.message,
        type: "error",
        visible: true,
      });
      dismissToastAfter(3000);
          ...
          <form className="settings-form" onSubmit={handleProfileSubmit}>
            <label className="agency-form__field">
              ...
              <input
                ...
                placeholder={pfSection.fields.name.placeholder}
                required
              />
            </label>
            <div className="settings-form__actions">
              <Button
                ...
                variant="solid"
                color="primary"
                text={profileSaving ? pfSection.buttons.save.saving : pfSection.buttons.save.text}
          ...
          <form className="settings-form" onSubmit={handlePassSubmit}>
            ...
            <label className="agency-form__field">
              ...
              <input
                ...
                placeholder={pwSection.fields.currentPassword.placeholder}
                required
              />
            </label>
            <label className="agency-form__field">
              ...
              <input
                ...
                placeholder={pwSection.fields.newPassword.placeholder}
                required
              />
            </label>
            <label className="agency-form__field">
              ...
              <input
                ...
                placeholder={pwSection.fields.confirmPassword.placeholder}
                required
              />
            </label>
            <div className="settings-form__actions">
              <Button
                ...
                color="primary"
                text={
                  passSubmitting ? pwSection.buttons.update.updating : pwSection.buttons.update.text
                }
