...
export function ConfirmModal({
  open,
  title = pageConfig.confirmModal.defaultTitle,
  message = pageConfig.confirmModal.defaultMessage,
  onCancel,
  onConfirm,
}) {
  if (!open) return null;
    ...
    <div className="tm-modal-overlay" role="dialog" aria-modal="true">
      <div className="tm-modal">
        ...
        <div className="tm-modal-actions">
          <Button
            type="button"
            primaryClassName="btn tm-btn-cancel"
            variant="outline"
            onClick={onCancel}
            text={pageConfig.confirmModal.cancelText}
          />
          <Button
            type="button"
            primaryClassName="btn tm-btn-danger"
            variant="solid"
            color="danger"
            onClick={onConfirm}
            text={pageConfig.confirmModal.confirmText}
          />
        </div>
      </div>
    </div>
...
export function Toast({ toast, setToast }) {
  ...
  return (
    <div
      className={`tm-toast tm-toast--${toast.type || "info"}`}
