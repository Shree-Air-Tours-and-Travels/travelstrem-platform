...
import SummaryCard from "../../shared/ui/cards/BookingSummaryCard/BookingSummaryCard.jsx";
...
export default function CheckoutPageView({ booking, tour, loading, error, processing, handlePay, handleGetQuote, navigate }) {
