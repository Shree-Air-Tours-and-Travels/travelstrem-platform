import { normalizeMongoId, resolveDepartureOption } from "../../modules/forms/services/departureOptionService.js";
...
describe("departure option resolution", () => {
  ...
  it("recovers an ObjectId serialized as a buffer object", () => {
    expect(normalizeMongoId({
      buffer: { 0: 106, 1: 133, 2: 203, 3: 249, 4: 128, 5: 110, 6: 39, 7: 61, 8: 205, 9: 84, 10: 11, 11: 207 },
