...
const rawTours = [
    {
        slug: "udaipur-complete-royal-escape",
        title: "Udaipur Complete Royal Escape",
        shortDescription:
            "Flights, premium stay, meals, transfers and guided sightseeing included.",
        city: { from: "Delhi", to: "Udaipur" },
        address: destination("Udaipur", "Rajasthan"),
        distance: 660,
        ...
        includedStays: [
            {
                nights: 3,
                location: "Udaipur",
                propertyName: "Lake-view heritage hotel",
                propertyClass: "5-star",
                roomType: "Deluxe room",
                meals: ["Breakfast", "Dinner"],
                description: "Premium stay included.",
            },
        ],
        hotelOptions: [
            {
                title: "Lake-view suite",
                description: "Upgrade to a larger suite.",
                costLabel: "Per person",
                cost: "₹4,500",
                pricing: optionPricing("PER_PERSON", 4500),
                active: true,
                recommended: true,
            },
        ],
        extras: [
            {
                ...
                description: "Private Lake Pichola boat experience.",
                price: 6000,
                pricing: optionPricing("PER_BOOKING", 6000),
                currency: "INR",
                active: true,
            },
        ],
        flights: { included: true, inventoryManaged: true },
        availability: { totalSeats: 12, seatsAvailable: 12 },
        maxGroupSize: 12,
        inclusions: [
        ...
        tags: ["all-inclusive", "heritage", "luxury", "domestic"],
        featured: true,
        trending: true,
    },
    {
        slug: "kerala-backwaters-flexible-itinerary",
        title: "Kerala Backwaters Flexible Itinerary",
        shortDescription:
            "An itinerary-only package with every stay, meal and transfer left to the traveller.",
        city: { from: "Kochi", to: "Alleppey" },
        address: destination("Alleppey", "Kerala"),
        distance: 55,
        ...
        maxGroupSize: 20,
        inclusions: ["Curated itinerary", "Local destination support"],
        exclusions: ["Flights", "Accommodation", "Meals", "Transfers", "Activities"],
        meetingPoint: "Kochi",
        tags: ["flexible", "budget", "backwaters", "domestic"],
        featured: false,
    },
    {
        slug: "goa-stay-and-breakfast-break",
        title: "Goa Stay and Breakfast Break",
        shortDescription: "Hotel and breakfast included; flights and local travel remain optional.",
        city: { from: "Mumbai", to: "Goa" },
        address: destination("Panaji", "Goa"),
        distance: 590,
        period: { days: 4, nights: 3 },
        ...
        includedStays: [
            {
                ...
                meals: ["Breakfast"],
                description: "Stay and breakfast included.",
            },
        ],
        hotelOptions: [
            {
                title: "Pool-view room",
                description: "Pool-facing category upgrade.",
                costLabel: "Per room per night",
                cost: "₹1,800",
                pricing: optionPricing("PER_ROOM_PER_NIGHT", 1800),
                active: true,
            },
        ],
        extras: [
            {
                ...
                description: "Shared full-day sightseeing.",
                price: 1800,
                pricing: optionPricing("PER_PERSON", 1800),
                currency: "INR",
                active: true,
            },
            {
                title: "Private airport transfer",
                description: "Private sedan transfer.",
                price: 2500,
                pricing: optionPricing("PER_BOOKING", 2500),
                currency: "INR",
                active: true,
            },
        ],
        ...
        availability: { totalSeats: null, seatsAvailable: null },
        maxGroupSize: 16,
        inclusions: ["Three-night resort stay", "Daily breakfast"],
        exclusions: ["Flights", "Airport transfers", "Lunch and dinner", "Optional activities"],
        meetingPoint: "Hotel reception",
        tags: ["beach", "family", "stay-included", "domestic"],
        featured: true,
    },
    {
        slug: "ladakh-flight-and-road-adventure",
        title: "Ladakh Flight and Road Adventure",
        shortDescription:
            "Flights and road transport included; meals and premium upgrades are optional.",
        city: { from: "Delhi", to: "Leh" },
        address: destination("Leh", "Ladakh"),
        distance: 1020,
        ...
        includedStays: [
            {
                nights: 5,
                location: "Leh and Nubra",
                propertyName: "Standard hotels and camp",
                propertyClass: "3-star",
                roomType: "Double sharing",
                meals: [],
                description: "Accommodation included; meals optional.",
            },
        ],
        hotelOptions: [
            {
                title: "Premium mountain hotels",
                description: "Premium properties throughout the circuit.",
                costLabel: "Per person",
                cost: "₹7,500",
                pricing: optionPricing("PER_PERSON", 7500),
                active: true,
            },
        ],
        extras: [
            {
                title: "Breakfast and dinner plan",
                description: "Daily breakfast and dinner.",
                price: 5500,
                pricing: optionPricing("PER_PERSON", 5500),
                currency: "INR",
                active: true,
            },
        ],
        flights: { included: true, inventoryManaged: true },
        availability: { totalSeats: 8, seatsAvailable: 8 },
        maxGroupSize: 8,
        inclusions: [
            "Return economy flights",
            "Shared road transport",
            "Accommodation",
            "Permits",
            "Tour coordinator",
        ],
        exclusions: ["Meals", "Travel insurance", "Personal expenses"],
        meetingPoint: "Delhi Airport",
        tags: ["adventure", "flights-included", "mountains", "domestic"],
        featured: true,
    },
];

await mongoose.connect(config.MONGO_URI);
const agency = await PartnerAgency.findOne({ status: { $in: ["active", "approved"] } }).sort({
    createdAt: 1,
});
const agent = agency
    ? await User.findOne({ role: "agent", partnerAgencyRef: agency._id }).sort({ createdAt: 1 })
    : null;
...
const tourDocuments = rawTours.map((tour) => {
    const searchTags = (tour.tags || []).map((name) => ({
        id: slugify(name),
        slug: slugify(name),
        name,
        type: "CUSTOM",
...
await TourDeparture.insertMany(
    tours.map((tour) => ({
        tourId: tour._id,
        origin: {
            cityId: tour.city.from.toLowerCase(),
    ...
    JSON.stringify(
        {
            ...
            deletedDemoTours: removableTours.map((tour) => tour.slug),
            toursCreated: tours.map((tour) => ({
                slug: tour.slug,
                flights: tour.flights,
                inclusions: tour.inclusions.length,
                extras: tour.extras.length,
            })),
        },
        null,
        2,
