...
export const getCategories = asyncHandler(async (_req, res) => ok(res, { categories: SUPPORT_CATEGORIES }));

export const getContacts = asyncHandler(async (_req, res) => ok(res, { contactOptions: PLATFORM_CONTACT_OPTIONS, emptyState: SUPPORT_UI.emptyStates.contacts }));
...
export const createTicket = asyncHandler(async (req, res) => {
  ...
  const ticket = await SupportTicket.create({
    ...
    user: userId(req), serviceId: requestedServiceId,
