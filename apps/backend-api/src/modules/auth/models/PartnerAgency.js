...
const partnerAgencySchema = new mongoose.Schema({
    ...
    settings: {
        ...
        bookingFees: { agentPercent: { type: Number, min: 0, default: 2 }, servicePercent: { type: Number, min: 0, default: 2 }, platformPercent: { type: Number, min: 0, default: 2 } },
    ...
    feeConfig: {
        ...
        chargingMode: { type: String, enum: ["CUSTOMER_FEE", "SETTLEMENT_DEDUCTION"], default: "SETTLEMENT_DEDUCTION" },
