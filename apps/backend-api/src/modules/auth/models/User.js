...
const userSchema = new mongoose.Schema({
    ...
    agencyRole: { type: String, enum: ["none", "partner_admin", "partner_agent"], default: "none", index: true },
    agencyId: { type: mongoose.Schema.Types.ObjectId, ref: "PartnerAgency", default: null, index: true },
    designation: { type: String, trim: true, default: "" },
    accountStatus: { type: String, enum: ["invited", "active", "suspended", "deactivated", "anonymized"], default: "active", index: true },
