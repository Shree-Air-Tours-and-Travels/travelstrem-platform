...
const pricingObjectWidgets = ({ units, amountLabel, unitDefault }) =>
    [
        ...
        },
        {
            ...
            path: "amountMinor",
            label: amountLabel,
            help: "Integer minor units (paise)",
            validation: [{ type: "MIN", value: 0, message: "Must be zero or more" }],
        },
        {
            key: "currency",
            type: "SELECT",
            path: "currency",
            label: "Currency",
            optionsSource: CURRENCY_OPTIONS_SOURCE,
        },
...
const destinationWidgets = (prefixLabel) => [
    {
        ...
        type: "TEXT",
        path: "destinationId",
        label: `${prefixLabel} destination id`,
    },
...
export const BUILDER_STEPS = Object.freeze([
                ...
                children: [
                    {
                        ...
                        widgets: [
                            ...
                            },
                            {
                                ...
                                rows: 2,
                                validation: [{ type: "MAX_LENGTH", value: 240 }],
                            },
                            {
                                key: "agentRef",
                                type: "TEXT",
                                ...
                                help: "Internal code shown in operations lists.",
                            },
                            {
                                key: "providerName",
                                type: "TEXT",
                                path: "providerName",
                                label: "Provider name",
                                capabilities: { canEditPlatformMeta: true },
                            },
                            {
                                key: "slug",
                                type: "TEXT",
                                path: "slug",
                                label: "URL slug",
                                help: "Leave blank to auto-generate from the title.",
                                capabilities: { canEditPlatformMeta: true },
                                validation: [
                                    {
                                        type: "PATTERN",
                ...
                children: [
                    {
                        ...
                        widgets: [
                            ...
                            },
                            {
                                ...
                                validation: [
                                    REQUIRED,
                                    { type: "MIN", value: 1, message: "Days must be at least 1" },
                                ],
                            },
                            {
                                key: "nights",
                                ...
                                validation: [
                                    REQUIRED,
                                    {
                                        type: "MIN",
                                        value: 0,
                                        message: "Nights must be zero or more",
                                    },
                                ],
                            },
                            {
                        ...
                        widgets: [
                            {
                                ...
                                optionsSource: {
                                    type: "OPTION_SET",
                                    key: "trevista.packageTypeOptions",
                                },
                                validation: [REQUIRED],
                            },
                        ],
                        ...
                        widgets: [
                            {
                                ...
                                defaultItem: {
                                    status: "active",
                                    pricing: { currency: "INR", isFinal: false, source: "manual" },
                                },
                                ...
                                validation: [
                                    {
                                        ...
                                        value: 1,
                                        message:
                                            "Fixed departure tours need at least one departure",
                                        visibleWhen: {
                                            field: "packageType",
                                            operator: "EQUALS",
                                            value: "fixed_departure",
                                ...
                                itemWidgets: [
                                    ...
                                    },
                                    {
                                        ...
                                        optionsSource: {
                                            type: "OPTION_SET",
                                            key: "trevista.departureStatusOptions",
                                        },
                                    },
                                    {
                                        key: "departureDate",
                                    ...
                                    },
                                    {
                                        key: "isFinal",
                                        type: "CHECKBOX",
                                        path: "pricing.isFinal",
                                        label: "Final price (not approximate)",
                                        halfWidth: true,
                                    },
                                    {
                                        key: "source",
                        ...
                        widgets: [
                            {
                                ...
                                widgets: [
                                    ...
                                    },
                                    {
                                        ...
                                        optionsSource: {
                                            type: "OPTION_SET",
                                            key: "trevista.flexiblePricingModelOptions",
                                        },
                                    },
                                    {
                        ...
                        widgets: [
                            {
                                ...
                                widgets: [
                                    {
                                        key: "responseTimeframeHours",
                                        type: "NUMBER",
                                        path: "responseTimeframeHours",
                                        label: "Response timeframe (hours)",
                                        min: 1,
                                        halfWidth: true,
                                    },
                                    {
                                        ...
                                        type: "SWITCH",
                                        path: "requireDates",
                                        label: "Require travel dates",
                                        halfWidth: true,
                                    },
                                    {
                                        key: "requireGroupSize",
                                        type: "SWITCH",
                                        path: "requireGroupSize",
                                        label: "Require group size",
                                        halfWidth: true,
                                    },
                                    {
                                        key: "allowAgentDraft",
                                        type: "SWITCH",
                                        path: "allowAgentDraft",
                                        label: "Allow agent drafts",
                                        halfWidth: true,
                                    },
                                    {
                                        key: "allowCustomerCustomization",
                                        type: "SWITCH",
                                        path: "allowCustomerCustomization",
                                        label: "Allow customer customisation",
                                        halfWidth: true,
                                        help: "Shows the full customisation request only for this custom tour.",
                                    },
                                    {
                                        key: "questionnaireFields",
                                        type: "TAGS",
                                        path: "questionnaireFields",
                                        label: "Questionnaire fields",
                                        help: "One question per entry",
                                    },
                                ],
                            },
                        ],
                        ...
                        widgets: [
                            {
                                key: "seasonalPricing",
                                type: "REPEATER",
                                path: "seasonalPricing",
                                label: "Season",
                                addLabel: "Add season",
                                itemLabelPath: "seasonName",
                                ...
                                widgets: [
                                    {
                                        ...
                                        type: "SELECT",
                                        path: "feeType",
                                        label: "Agent fee method",
                                        required: true,
                                        halfWidth: true,
                                        options: [
                                            {
                                                value: "PERCENTAGE",
                                                label: "Percentage of supplier cost",
                                            },
                                    ...
                                    },
                                    {
                                        ...
                                        halfWidth: true,
                                        visibleWhen: {
                                            field: "commercial.pricingPolicy.feeType",
                                            operator: "EQUALS",
                                            value: "PERCENTAGE",
                                        },
                                        validation: [
                                            {
                                                type: "MIN",
                                                value: 0,
                                                message: "Agent fee must be between 0% and 100%",
                                            },
                                            {
                                                type: "MAX",
                                                value: 100,
                                        ...
                                        validation: [
                                            {
                                                ...
                                                value: 0,
                                                message:
                                                    "Fixed fee must be whole paise, zero or more",
                                            },
                                        ],
                                    },
                                    {
                                    ...
                                    },
                                    {
                                        ...
                                        type: "TEXT",
                                        path: "gstOn",
                                        label: "GST applies to",
                                        readOnly: true,
                                        halfWidth: true,
                                        help: "GST is applied to the agent fee.",
                                    },
                                ],
                            },
                        ],
                                ...
                                validation: [
                                    {
                                        type: "MIN_ITEMS",
                                        value: 1,
                                        message: "Add at least one priced component",
                                    },
                                ],
                                itemWidgets: [
                                    {
                                    ...
                                    },
                                    {
                                        ...
                                        optionsSource: {
                                            type: "OPTION_SET",
                                            key: "trevista.commercialComponentTypeOptions",
                                        },
                                        validation: [REQUIRED],
                                    },
                                    {
                                    ...
                                    },
                                    {
                                        ...
                                        optionsSource: {
                                            type: "OPTION_SET",
                                            key: "trevista.commercialStatusOptions",
                                        },
                                    },
                                    {
                                        key: "active",
                                    ...
                                    },
                                    {
                                        key: "upgrade",
                                        type: "SELECT",
                                        path: "replacesComponentKey",
                                        label: "Replaces component (upgrade)",
                                        optionsSource: { type: "SIBLING_COMPONENTS" },
                                        clearable: true,
                                        ...
                                        widgets: [
                                            {
                                                ...
                                                optionsSource: {
                                                    type: "OPTION_SET",
                                                    key: "trevista.commercialPricingUnitOptions",
                                                },
                                                validation: [REQUIRED],
                                            },
                                            {
                                                key: "costAmountMinor",
                                                type: "NUMBER",
                                                path: "costAmountMinor",
                                                label: "Supplier cost (paise)",
                                                min: 0,
                                                required: true,
                                                halfWidth: true,
                                                capabilities: { viewCosts: true },
                                                validation: [
                                                    {
                                                        type: "INTEGER_MIN",
                                                        value: 0,
                                                        message: "Whole paise, zero or more",
                                                    },
                                                ],
                                            },
                                        ],
                                    },
                                    {
                                        ...
                                        help: "Arbitrary structured details preserved verbatim.",
                                        height: 140,
                                    },
                                ],
                            },
                                ...
                                validation: [
                                    {
                                        ...
                                        min: 2,
                                        max: 3,
                                        message: "Enable two or three packages before continuing",
                                    },
                                ],
                            },
                        ],
                ...
                children: [
                    {
                        ...
                        widgets: [
                            {
                                key: "derived",
                                type: "DERIVED_PRICING",
                                path: "commercial.derived",
                                readOnly: true,
                                ...
                                copy: {
                                    ...
                                    empty: {
                                        label: "Assign items to an enabled package to see its total.",
                                    },
                                },
                            },
                        ],
                        ...
                        widgets: [
                            {
                                ...
                                itemTitle: (item, index) =>
                                    `Day ${item?.day ?? index + 1}${item?.title ? ` — ${item.title}` : ""}`,
                                validation: [
                                    {
                                        type: "DAY_SEQUENCE",
                                        message: "Day numbers must be sequential starting at 1",
                                    },
                                ],
                                itemWidgets: [
                                    {
                                        ...
                                        required: true,
                                        halfWidth: true,
                                        validation: [REQUIRED, { type: "MIN", value: 1 }],
                                    },
                                    {
                                        key: "location",
                                        type: "TEXT",
                                    ...
                                    {
                                        key: "structuredActivities",
                                        type: "REPEATER",
                                        path: "structuredActivities",
                                    ...
                                    },
                                    {
                                        ...
                                        type: "TAGS",
                                        path: "activities",
                                        label: "Legacy activities",
                                        help: "Free-text activity lines kept for older consumers.",
                                    },
                                    {
                                        key: "meals",
                                        type: "TAGS",
                                        path: "meals",
                                        label: "Meals",
                                        help: "e.g. Breakfast, Lunch, Dinner",
                                    },
                                    {
                                        key: "notes",
                                        type: "TEXTAREA",
                        ...
                        widgets: [
                            {
                                ...
                                label: "Stay",
                                addLabel: "Add stay",
                                itemLabelPath: "propertyName",
                                defaultItem: { nights: 1, meals: [], pricing: { currency: "INR" } },
                                itemTitle: (item, index) =>
                                    item?.propertyName || `Stay ${index + 1}`,
                                itemWidgets: [
                                    {
                                        key: "propertyName",
                                        type: "TEXT",
                                    ...
                                    },
                                    {
                                        ...
                                        type: "OBJECT",
                                        path: "pricing",
                                        widgets: pricingObjectWidgets({
                                            units: HOTEL_UNITS,
                                            amountLabel: "Supplement (paise)",
                                        }),
                                    },
                                ],
                            },
                        ...
                        widgets: [
                            {
                                ...
                                itemTitle: (item, index) =>
                                    item?.title || `Hotel option ${index + 1}`,
                                itemWidgets: [
                                    {
                                        key: "optionKey",
                                        type: "TEXT",
                                    ...
                                    },
                                    {
                                        ...
                                        required: true,
                                        halfWidth: true,
                                        help: "Use the same key for interchangeable hotels in one destination, for example leh-stay.",
                                        validation: [
                                            REQUIRED,
                                            {
                                                type: "PATTERN",
                                    ...
                                    },
                                    {
                                        ...
                                        type: "TAGS",
                                        path: "packageKeys",
                                        label: "Included in package keys",
                                        help: "Package keys where this hotel choice is already included.",
                                    },
                                    {
                                        key: "amenities",
                                        type: "TAGS",
                                    ...
                                    },
                                    {
                                        ...
                                        widgets: pricingObjectWidgets({
                                            units: HOTEL_UNITS,
                                            amountLabel: "Supplier upgrade cost (paise)",
                                        }),
                                    },
                                    {
                                        key: "rooms",
                                        ...
                                        itemWidgets: [
                                            ...
                                            },
                                            {
                                                ...
                                                path: "packageKeys",
                                                label: "Included in package keys",
                                                help: "For example: base uses Standard Room and premium uses Deluxe Room. Assign only one room per hotel to each package.",
                                            },
                                            {
                                                key: "meals",
                                                type: "TAGS",
                                            ...
                                            },
                                            {
                                                ...
                                                widgets: pricingObjectWidgets({
                                                    units: HOTEL_UNITS,
                                                    amountLabel: "Supplier room cost (paise)",
                                                }),
                                            },
                                        ],
                                    },
                        ...
                        widgets: [
                            {
                                ...
                                widgets: [
                                    ...
                                    },
                                    {
                                        ...
                                        halfWidth: true,
                                        visibleWhen: {
                                            field: "cancellation.depositRequired",
                                            operator: "EQUALS",
                                            value: true,
                                        },
                                    },
                            ...
                            },
                            {
                                ...
                                label: "Legacy cancellation policy line",
                                rows: 2,
                            },
                        ],
                    },
                        ...
                        widgets: [
                            {
                                ...
                                itemWidgets: [
                                    ...
                                    },
                                    {
                                        ...
                                        optionsSource: {
                                            type: "OPTION_SET",
                                            key: "trevista.extraCategoryOptions",
                                        },
                                    },
                                    {
                                        key: "icon",
                ...
                children: [
                    {
                        ...
                        widgets: [
                            ...
                            },
                            {
                                key: "seatsAvailable",
                                type: "NUMBER",
                                path: "availability.seatsAvailable",
                                label: "Seats available",
                                min: 0,
                                halfWidth: true,
                            },
                    ...
                    },
                    {
                        ...
                        widgets: [
                            ...
                            },
                            {
                                ...
                                path: "flights",
                                visibleWhen: {
                                    field: "flights.included",
                                    operator: "EQUALS",
                                    value: true,
                                },
                                widgets: [
                                    {
                                        key: "inventoryManaged",
                                        type: "SWITCH",
                                        path: "inventoryManaged",
                                        label: "Inventory managed here",
                                    },
                                    {
                                        key: "pricePerPerson",
                                        type: "NUMBER",
                ...
                children: [
                    {
                        ...
                        widgets: [
                            ...
                            },
                            {
                                ...
                                validation: [
                                    REQUIRED,
                                    { type: "MIN", value: 1, message: "At least 1 traveller" },
                                ],
                            },
                        ],
                    },
                        ...
                        widgets: [
                            {
                                ...
                                type: "TAGS",
                                path: "tags",
                                label: "Tour themes and keywords",
                                help: "Add useful themes such as family or adventure. Destination and travel-type tags are added automatically.",
                            },
                        ],
                    },
                ],
    ...
    /* ------------------------------------------------------------------ */
    {
        ...
        description: "Traveller-facing content, analytics and publish controls.",
        icon: "people",
        order: 9,
        ownedPaths: [
            "rating",
        ...
        substeps: [
                        ...
                        widgets: [
                            {
                                ...
                                help: "Describe the route, experience, inclusions and important traveller expectations.",
                                rows: 5,
                                required: true,
                                validation: [REQUIRED, { type: "MAX_LENGTH", value: 5000 }],
                            },
                        ],
                    },
                ],
                ...
                children: [
                    {
                        ...
                        widgets: [
                            {
                                key: "rating",
                                type: "READONLY_OBJECT",
                                path: "rating",
                                label: "Traveller rating",
                                readOnly: true,
                                presentation: "metrics",
                                fields: [
                                    { key: "average", label: "Average rating", icon: "star", format: "rating" },
                                    { key: "count", label: "Verified reviews", icon: "messageCircle" },
                                ],
                            },
                            {
                                key: "metrics",
                                type: "READONLY_OBJECT",
                                path: "metrics",
                                label: "Traveller engagement",
                                readOnly: true,
                                presentation: "metrics",
                                fields: [
                                    { key: "views", label: "Tour views", icon: "eye" },
                                    { key: "enquiries", label: "Enquiries", icon: "messageCircle" },
                                    { key: "bookings", label: "Bookings", icon: "briefcaseBusiness" },
                                    { key: "wishlists", label: "Wishlists", icon: "heart" },
                                    { key: "popularityScore", label: "Popularity", icon: "sparkles", format: "score" },
                                    { key: "trendScore", label: "Trend strength", icon: "star", format: "score" },
                                    { key: "lastViewedAt", label: "Last viewed", kind: "detail", format: "date" },
                                    { key: "lastEnquiredAt", label: "Last enquiry", kind: "detail", format: "date" },
                                    { key: "lastBookedAt", label: "Last booking", kind: "detail", format: "date" },
                                    { key: "lastWishlistedAt", label: "Last wishlisted", kind: "detail", format: "date" },
                                ],
                                capabilities: { canEditMetrics: true, readOnlyUnlessCapable: true },
                            },
                        ],
                    },
                ],
            },
            {
                ...
                children: [
                    {
                        childKey: "publishing",
                        title: "Publishing & TravelsTREM intelligence",
                        widgets: [
                            {
                                key: "featured-request",
                                type: "SWITCH",
                                path: "featuredRequest.requested",
                                label: "Request featured consideration",
                                help: "TravelsTREM evaluates content quality, verification, reliability and traveller engagement. A request does not guarantee placement.",
                            },
                            {
                                key: "tour-intelligence-summary",
                                type: "TOUR_INTELLIGENCE_SUMMARY",
                                path: "intelligence",
                            ...
                            },
                            {
                                ...
                                optionsSource: {
                                    type: "OPTION_SET",
                                    key: "trevista.tourStatusOptions",
                                },
                        ...
                        widgets: [
                            {
                                ...
                                itemTitle: (item, index) =>
                                    item?.origin?.cityName || item?._id || `Departure ${index + 1}`,
                                itemWidgets: [
                                    {
                                        key: "o-city-id",
                                        type: "TEXT",
                        ...
                        widgets: [
                            {
                                ...
                                copy: {
                                    ...
                                    packagePending: {
                                        label: "Add package pricing to preview customer options.",
                                    },
...
export const getBuilderDefinition = () => ({
    ...
    ui: {
        ...
        edit: {
            ...
            savedMessage: "Changes saved. You can continue editing or choose another step.",
        },
        view: { title: "Review tour", label: "Tour review" },
    },
    steps: BUILDER_STEPS.map(
        ({ stepKey, title, description, icon, order, collection, readOnlyStep }) => ({
            stepKey,
            title,
            description,
            icon,
    ...
    return [
        {
            ...
            required,
            ...(minimumItems
                ? { minItems: Number(minimumItems.value), message: minimumItems.message }
                : {}),
            ...(maximumItems
                ? { maxItems: Number(maximumItems.value), message: maximumItems.message }
                : {}),
            ...(enabledCount
                ? {
                      enabledMin: Number(enabledCount.min),
                      enabledMax: Number(enabledCount.max),
                      message: enabledCount.message,
                  }
                : {}),
        },
    ];
...
export const stepNeighbours = (stepKey) => {
    ...
    return {
        ...
        nextStepKey:
            index >= 0 && index < BUILDER_STEPS.length - 1
                ? BUILDER_STEPS[index + 1].stepKey
                : null,
    };
};
