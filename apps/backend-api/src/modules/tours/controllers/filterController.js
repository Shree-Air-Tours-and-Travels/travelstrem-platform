...
const filterWidgetPath = path.resolve(__dirname, "../../../data/tours-remote/listing/widgets/tour-filters.json");
...
export const getFilters = async (req, res) => {
  try {
    ...
    return res.status(500).json({ status: "error", code: "TOUR_FILTERS_FAILED", message: "Tour filters could not be loaded" });
  }
};
