...
export const DEFAULT_PLATFORM_PRODUCTS = Object.freeze([
  ...
  Object.freeze({ key: "trevista", name: "Trevista", description: "Custom tours and travel services" }),
]);
...
export async function ensureDefaultPlatformProducts() {
  await Promise.all(DEFAULT_PLATFORM_PRODUCTS.map((product) => Product.updateOne(
    { key: product.key },
