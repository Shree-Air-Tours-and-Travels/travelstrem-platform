...
import { latestQuoteDocument, getQuoteDocumentSignedUrl } from "../services/QuoteDocumentStorage.js";
...
export async function getQuotePdfSignedUrl(req, res) {
  try {
    ...
    if (!canAccessQuote(req, quote)) return sendError(res, "Not authorized to download this quote", 403);
    if (!quote.bookingId || quote.version == null) return sendError(res, "The generated quote PDF is unavailable", 404);
