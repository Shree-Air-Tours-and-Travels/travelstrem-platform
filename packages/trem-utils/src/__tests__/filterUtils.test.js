...
describe('validateField', () => {
  ...
  describe('multiselect type', () => {
    it('validates min/max items', () => {
      const field = { type: 'multiselect', minItems: 1, maxItems: 3, options: [{ value: 'a' }, { value: 'b' }, { value: 'c' }, { value: 'd' }] };
  ...
  describe('custom messages', () => {
    ...
    it('uses validation sub-object messages', () => {
      const field = { type: 'text', required: true, validation: { messages: { required: 'Nested required' } } };
      const result = validateField('name', '', field);
