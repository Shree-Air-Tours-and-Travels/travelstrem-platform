...
export default function IncludedStaysContainer({ tourRef, selectedPackage, hotelSelections = {}, onSelectHotel, onCustomize, onRequestHotel }) {
    const { loading, error, widgetData } = useTourDetailWidget(tourRef, "included-stays.json", { packageKey: selectedPackage });
