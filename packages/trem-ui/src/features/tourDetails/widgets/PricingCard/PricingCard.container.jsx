...
export default function PricingCardContainer({ tourRef, tour: fallbackTour, onContact, onShare, isFavorited, onFavorite }) {
    ...
    const packagePrices = useMemo(() => {
        ...
        return pricing.packages
            ...
            .map((item) => ({
                ...
                name: item.name || ({ BASIC: "Base", STANDARD: "Standard", PREMIUM: "Premium" }[item.tier]) || "Package",
    ...
    return (
        <PricingCardView
            ...
            priceDisplayMode={tour?.commercialPricing?.displayMode || (tour?.priceInfo?.isFinal ? "FINAL" : "ESTIMATED")}
