...
/**
 * Tour catalog feed for listing pages. Published-tour edits and publish
 * transitions are broadcast to the shared catalog room (joined automatically
 * at connect), so every open listing refreshes without a reload. Draft-only
 * edits intentionally do not reach the public catalog.
 *
