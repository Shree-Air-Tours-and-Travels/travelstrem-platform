    ...
    fields: [
      {
        ...
        type: "select",
        label: "Type",
        options: FieldOptions.travellerTypes,
        required: true,
      },
      ...
      },
      {
        ...
        type: "select",
        label: "Nationality",
        options: FieldOptions.nationalities,
        required: true,
        colSpan: 2,
        searchable: true,
      },
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "select",
        label: "Visa status",
        options: FieldOptions.visaStatuses,
      },
    ],
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "select",
        label: "Relation",
        options: FieldOptions.emergencyRelations,
        searchable: true,
      },
      {
    ...
    fields: [
      {
        ...
        options: FieldOptions.dietaryPreferences,
        searchable: true,
      },
      {
        ...
        options: FieldOptions.medicalConditions,
        searchable: true,
      },
      {
        name: "wheelchairRequired",
        type: "switch",
        label: "Wheelchair assistance needed",
        switchLabel: "Yes, wheelchair assistance is required",
      },
    ],
  },
];
...
export default {
  ...
  argTypes: {
    ...
    "layout.defaultExpanded": {
      control: "boolean",
      description: "Default open state of collapsible sections",
    },
    "layout.showExpandAll": {
      control: "boolean",
      description: "Show Expand all / Collapse all toolbar",
    },
    "layout.columns": {
...
export const CollapsedByDefault = {
  args: {
    config: {
      ...travellerConfig,
      layout: {
        ...travellerConfig.layout,
        defaultExpanded: false,
        expandAllLabel: "Expand all sections",
    ...
    return (
      <ControlledDemo
        config={{
          ...
          layout: {
            ...layout,
            expandable: layout.expandable ?? true,
            defaultExpanded: layout.defaultExpanded ?? true,
            showExpandAll: layout.showExpandAll ?? false,
